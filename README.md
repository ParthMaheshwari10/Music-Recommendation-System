...
The original toy implementation remains in `music_recommender.py` and
`create.py` for historical comparison. The maintained system is the `moodmix`
package under `src/`.
...
├── create.py                  # Legacy synthetic-data generator
├── music_recommender.py       # Legacy prototype
